...
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/verifatt.sh > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/verpweb > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/verweb > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://github.com/Cyber-ssh/pweb_v5/raw/main/PainelWebV5/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@CYBERSSH\033[0m" | lolcat
echo ""
